...
import com.example.backend.Repository.CompanyReository;
import com.example.backend.Repository.LaptopRepository;
...
public class LaptopService {
 ...
 @PersistenceContext
    ...
    @Autowired
    private CompanyReository companyRepository;
